...
public class RealEstateController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<ListResponseBaseDto<GetRealEstatesResponseDto>>> GetRealEstates(
        [FromQuery] RealEstateQuery request)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<ResultResponse<UpdateRealEstateResponseDto>>> UpdateRealEstate([FromRoute] Guid id,
    ...
    public async Task<ActionResult<ResultResponse<UploadDocumentsResponseDto>>> UploadDocuments(
        [FromRoute] Guid realEstateId, IFormFile file)
    {
